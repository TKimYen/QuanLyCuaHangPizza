...
//        lblLoai.setFont(font);
        ...
        Dimension sizeLabel = lblLoai.getPreferredSize();
        lblNhanVien.setPreferredSize(sizeLabel);
        ...
        pnLeftBanHang.setPreferredSize(new Dimension(618, h - 20));
        ...
        pnThongTinBanHang.setPreferredSize(new Dimension(
                pnRightBanHang.getSize().width,(int) (pnTableBanHang.getPreferredSize().getHeight()+ 150)
            ));
