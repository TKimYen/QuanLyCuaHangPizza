...
public class DangNhapGUI extends JFrame {
    ...
    private void addControls() {
        ...
        pnMain = new ImagePanel("image/LoginUI/background-login-pizzashop.png");
        pnMain.setLayout(null);

        btnExit = new JLabel(new ImageIcon("image/LoginUI/btn-close.png"));
        btnExit.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        btnExit.setBounds(399, 0, 40, 40);
        ...
        btnForgot.setBounds(130, 575, 176, 30);

        Font fontTXT = new Font("", Font.BOLD, 18);
        txtUser = new JTextField();
        txtUser.setBackground(new Color(247,243,234));
        txtUser.setBorder(BorderFactory.createLineBorder(Color.lightGray, 2));
        ...
        txtPassword.setBackground(new Color(247,243,234));
        txtPassword.setBorder(BorderFactory.createLineBorder(Color.lightGray, 2));
