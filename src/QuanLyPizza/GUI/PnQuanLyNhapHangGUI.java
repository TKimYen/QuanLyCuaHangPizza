...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnResetKho.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir")+ "\\src\\image\\Refresh-icon.png"));
        ...
        btnResetTabXemLai.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir")+ "\\src\\image\\Refresh-icon.png"));
        ...
        jPanel24Layout.setVerticalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jPanel26, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        pnPhieuNhapLayout.setVerticalGroup(
            ...
            .addGroup(pnPhieuNhapLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jPanel18, javax.swing.GroupLayout.DEFAULT_SIZE, 309, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnXoaKhoiGioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaKhoiGioActionPerformed
        ...
        if (row > -1) {
            ...
            new MyDialog("Chưa chọn  :)", MyDialog.ERROR_DIALOG);
        }
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        if (row < 1) {
            new MyDialog("Chưa có!", MyDialog.ERROR_DIALOG);
            return;
        }
